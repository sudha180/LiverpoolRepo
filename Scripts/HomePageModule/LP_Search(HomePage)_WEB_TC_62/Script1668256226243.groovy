...
L1CategoryName = WebUI.getText(findTestObject('Object Repository/HomePage/L1Category_HP'))

WebUI.click(findTestObject('Object Repository/HomePage/L1Category_HP'))
